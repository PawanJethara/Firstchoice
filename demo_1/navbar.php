    ...
    <div class="navbar-content">
        <form class="search-form">
            ...
            <ul class="navbar-nav me-auto mb-2 ml-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="personaltable.php">Personal Information</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="collegetable.php">Cinformation</a>
                </li>
                <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    <div class="dropdown-header d-flex flex-column align-items-center">
                        ...
                        <div class="info text-center">
                            <p class="name font-weight-bold mb-0">Pawan Jethara</p>
                            <p class="email text-muted mb-3">pawanjethara924.com</p>
                        </div>
                    </div>
                    <div class="dropdown-body">
